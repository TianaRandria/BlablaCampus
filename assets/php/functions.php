...
function register()
{
  ...
  $register = connect()->prepare("INSERT INTO compte (name_user, nickname_user, password_user, email_user, bio_user) VALUES  (:name_user, :nickname_user, :password_user, :email_user, :bio_user), INSERT INTO stu_information ( stu_photograph ) VALUES (LOAD_FILE('/image_path/image_fileName.png'))");
