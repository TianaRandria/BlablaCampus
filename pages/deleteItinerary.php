...
<main class="flex flex-col w-5/6 justify-start items-start py-2 gap-10">
    ...
    <p class="font-epilogue colorGrey text-sm font-medium">Etes vous sur de vouloir supprimer ce trajet?</p>
    <form action="confirmation.php" class="w-full flex flex-col items-center p-4" method="post">
        ...
        <a href="myItinerary.php" class="w-full rounded-lg colorRedOnline font-workSans tracking-5px text-sm p-4 uppercase font-normal text-center">Retour</a>
    </form>
</main>
