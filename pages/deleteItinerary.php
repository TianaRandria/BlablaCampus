...
<main class="flex flex-col w-5/6 justify-start items-start py-2 gap-10">
  ...
  <form action="../assets/php/conditions.php?id_traject=<?php echo $idItinerary['id_traject'] ?>" class="w-full flex flex-col items-center p-4" method="post">
    <input type="hidden" name="idToDelete" value="<?php echo ($_POST['idToTransfepr']) ?>">
