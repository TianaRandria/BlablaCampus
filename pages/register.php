...
<form action="confirmation.php" method="post" class="flex flex-col w-5/6 gap-3" id="formRegister">
    ...
    <label for="profilePictureRegister" id="profilePictureRegisterLabel" class="bg-xtraLightGrey rounded-lg flex flex-col justify-center items-center w-full h-48">
