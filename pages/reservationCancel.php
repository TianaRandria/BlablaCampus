...
$idItineraryCancel = $idItineraryObjectDelet->getIdTrajects();
?>
...
<main class="flex flex-col w-5/6 justify-start items-start py-2 gap-10">
  ...
  <form action="../assets/php/conditions.php?id_traject=<?php echo $idItineraryCancel['id_traject'] ?>" class="w-full flex flex-col items-center p-2" method="post">
