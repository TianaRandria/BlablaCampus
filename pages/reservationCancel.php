...
<main class="flex flex-col w-5/6 justify-start items-start py-2 gap-10">
  ...
  <form action="../assets/php/conditions.php" class="w-full flex flex-col items-center p-2" method="post">
    <input type="hidden" name="idToCancel" value="<?php echo ($_POST['idToTransfer']) ?>">
