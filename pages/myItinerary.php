         ...
         <div class="flex w-full justify-between items-center rounded-lg bg-xtraLightGrey p-3 h-24 relative cardTraject" id="' . $myItinerary[$i]['id_traject'] . '">
             <div class="flex w-3/5 justify-between items-center h-full">
                 ...
                 <div class="h-full flex flex-col items-start justify-center">
                     <p class="startingPoint text-lightGrey font-medium text-sm font-epilogue">' . $myItinerary[$i]['start_traject'] . '</p>
                     <p class="endingPoint text-lightGrey font-medium text-sm font-epilogue">' . $myItinerary[$i]['end_traject'] . '</p>
                 </div>
             </div>
