...
<form action="../assets/php/conditions.php" method="post" class="flex flex-col w-5/6 gap-3" id="formEdit">
    ...
    <input type="text" name="nameEdit" placeholder="<?php echo $_SESSION['name_user'] ?>" class="bg-xtraLightGrey rounded-lg p-2" value="">
    <input type="text" name="nicknameEdit" placeholder="<?php echo $_SESSION['nickname_user'] ?>" class="bg-xtraLightGrey rounded-lg p-2" value="">
    ...
    <input type="email" name="emailEdit" placeholder="<?php echo $_SESSION['email_user'] ?>" class="bg-xtraLightGrey rounded-lg p-2" value="">
    ...
    <textarea name="bioEdit" id="bioEdit" cols="30" rows="8" placeholder="<?php echo $_SESSION['bio_user'] ?>" class="bg-xtraLightGrey rounded-lg resize-none" maxlength="140" value=""></textarea>
