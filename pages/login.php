...
<form action="confirmation.php" method="post" class="flex flex-col w-5/6 gap-9">
    ...
    <div class="flex flex-col items-center justify-center w-full gap-9">
        <input type="submit" name="action" value="SE CONNECTER" class="cursor-pointer BGColorRedOnline rounded-lg tracking-5px font-workSans text-white text-sm w-3/4 py-2">
        <a href="pswdReset.php" class="tracking-5px colorRedOnline font-workSans text-xs">MOT DE PASSE OUBLIÉ</a>
    </div>
</form>
