...
<main class="w-5/6 py-2">
    ...
    <form action="./searchItinerary" method="post" class="w-full flex flex-col items-start justify-start gap-3">
        ...
        <div class="flex w-full gap-2 p-2 bg-xtraLightGrey rounded-lg relative" id="startingPointCreating">
            ...
            <input type="text" name="createItineraryDepart" id="createItineraryDepart" placeholder="Départ" required class="bg-transparent placeholder:text-black w-full" autocomplete="off" value="<?= $_POST['starting_point'] ?>">
        ...
        <div class="w-full toChange hidden">
            ...
            <div class="flex w-full justify-start items-center gap-2 bg-xtraLightGrey p-2">
                ...
                <select name="itineraryFinalCreate" id="itineraryFinalCreate" class="box-border w-full bg-transparent" required>
                    <option value="46.668589,5.553935" <?php if($_POST['end_point'] == '46.668589,5.553935'){ echo 'selected';}?>>2 Route De Montaigu, 39000 Lons-le-Saunier, France</option>
                    <option value="46.6709261,5.5631747" <?php if($_POST['end_point'] == '46.6709261,5.5631747'){ echo 'selected';}?>>13b Avenue du Stade Municipal, 39000 Lons-le-Saunier</option>
                </select>
            </div>
            ...
            <fieldset class="flex flex-row-reverse w-full justify-end items-center gap-6" id="typeOfTraject">
                <div class="flex flex-row-reverse justify-start items-center gap-2">
                    ...
                    <input type="checkbox" name="typeTrajetTest" id="backForth" value="1" <?php if($_POST['type_Traject'] == 1){echo 'checked';} ?>>
                </div>
                <div class="flex flex-row-reverse justify-start items-center gap-2">
                    <label for="forthOnly" class="font-epilogue text-sm">Allez simple</label>
                    <input type="checkbox" name="typeTrajetTest" id="forthOnly" value="0" <?php if($_POST['type_Traject'] == 0){echo 'checked';} ?>>
                </div>
            </fieldset>
